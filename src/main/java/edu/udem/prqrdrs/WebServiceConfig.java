...
public class WebServiceConfig {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema personasSchema) {
        ...
        wsdl11Definition.setPortTypeName("PersonasPort");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://udem.edu/prqrdrs/ws/soap");
        wsdl11Definition.setSchema(personasSchema);
